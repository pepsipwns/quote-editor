...
ActiveRecord::Schema[7.0].define(version: 2023_12_12_162220) do
  ...
  create_table "line_item_dates", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
